...
const i18n = {
    ku: {
        ...
        sales: 'فرۆشتن',
        expenses: 'خەرجی',
        netProfit: 'قازانجی خاو',
        orders: 'داواکاری',
        todaySales: 'فرۆشتنی ئەمڕۆ',
        todayExpenses: 'خەرجی ئەمڕۆ',
        todayNet: 'قازانجی ئەمڕۆ',
        todayOrders: 'داواکاریی ئەمڕۆ',
        weekSales: 'فرۆشتنی هەفتە',
        weekExpenses: 'خەرجی هەفتە',
        weekNet: 'قازانجی هەفتە',
        weekOrders: 'داواکاریی هەفتە',
        monthSales: 'فرۆشتنی مانگ',
        monthExpenses: 'خەرجی مانگ',
        monthNet: 'قازانجی مانگ',
        bestSelling: 'باشترین فرۆشراو',
        ...
        accessDenied: 'ڕێگە پێنەدرا',
        noDashboardAccess: 'تۆ ڕێگەت نییە بە بینینی داشبۆردی دارایی.',
        noSectionAccess: 'تۆ ڕێگەت نییە بە گەیشتن بەم بەشە.',
        userRole: 'ڕۆڵی بەکارهێنەر',
        userRoleHint: 'ڕۆڵەکەت هەڵبژێرە بۆ کۆنترۆڵکردنی دەستڕاگەیشتن بە داشبۆرد و تایبەتمەندییەکانی تر',
        selectRole: 'ڕۆڵ هەڵبژێرە',
        roleAdmin: 'بەڕێوەبەر',
        roleOwner: 'خاوەن',
        roleStaff: 'ستاف',
        roleCashier: 'کاشێر',
        saveRole: 'پاشەکەوتکردنی ڕۆڵ',
        roleSaved: 'ڕۆڵ پاشەکەوت کرا! تکایە پەڕەکە نوێبکەرەوە بۆ جێبەجێکردن.',
        expenses: 'خەرجیەکان',
    ...
    ar: {
        ...
        noDashboardAccess: 'ليس لديك صلاحية لعرض لوحة التحكم المالية.',
        noSectionAccess: 'ليس لديك صلاحية للوصول إلى هذا القسم.',
        userRole: 'دور المستخدم',
        userRoleHint: 'اختر دورك للتحكم في الوصول إلى لوحة التحكم والميزات الأخرى',
        ...
        roleCashier: 'كاشير',
        saveRole: 'حفظ الدور',
        roleSaved: 'تم حفظ الدور! يرجى تحديث الصفحة لتطبيق التغييرات.',
        expenses: 'المصروفات',
    ...
    en: {
        ...
        noDashboardAccess: 'You do not have permission to view the financial dashboard.',
        noSectionAccess: 'You do not have permission to access this section.',
        userRole: 'User Role',
        userRoleHint: 'Select your role to control access to dashboard and other features',
        ...
        roleCashier: 'Cashier',
        saveRole: 'Save Role',
        roleSaved: 'Role saved successfully. Please refresh the page to apply changes.',
        expenses: 'Expenses',
